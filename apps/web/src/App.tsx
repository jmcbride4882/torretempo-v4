  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/playground/a" element={<Suspense fallback={<div className="flex items-center justify-center min-h-screen"><div className="h-8 w-8 animate-spin rounded-full border-4 border-kresna-border border-t-primary-500" /></div>}><DesignA /></Suspense>} />
        <Route path="/playground/b" element={<Suspense fallback={<div className="flex items-center justify-center min-h-screen"><div className="h-8 w-8 animate-spin rounded-full border-4 border-kresna-border border-t-primary-500" /></div>}><DesignB /></Suspense>} />
        <Route path="/playground/c" element={<Suspense fallback={<div className="flex items-center justify-center min-h-screen"><div className="h-8 w-8 animate-spin rounded-full border-4 border-kresna-border border-t-primary-500" /></div>}><DesignC /></Suspense>} />
