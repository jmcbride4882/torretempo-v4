      ...
      <div className="relative z-10 w-full max-w-xl">
        ...
        {loadingState === 'loading' && (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="mt-4 text-sm text-zinc-500">{t('onboarding.loadingOrgs')}</p>
          </div>
        )}
        ...
        {loadingState === 'error' && (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <h3 className="mt-4 text-lg font-medium text-zinc-900">{t('errors.loadFailed')}</h3>
            <p className="mt-1 text-sm text-zinc-500">{t('errors.tryAgain')}</p>
            <Button
          ...
          <div className="space-y-6">
            ...
            <div className="relative py-2">
              ...
              <div className="relative flex justify-center">
                <span className="bg-zinc-50 px-4 text-xs text-zinc-400">{t('common.or')}</span>
              </div>
            </div>
