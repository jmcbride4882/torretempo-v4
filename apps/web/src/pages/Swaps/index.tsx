...
export default function SwapsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">{t('swaps.subtitle')}</p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative flex-1 sm:max-w-xs">
          ...
          <Input
            ...
            className="rounded-xl border-slate-200 bg-white pl-9 text-slate-900 placeholder:text-slate-400 focus:border-primary-500"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:flex sm:items-center sm:gap-2">
            ...
            >
              <SelectTrigger className="w-[160px] rounded-xl border-slate-200 bg-white text-slate-900">
      ...
      {showFilters && (
        <div className="rounded-xl border border-slate-200 bg-white p-4 sm:hidden">
          <div className="space-y-3">
            ...
            {statusFilter !== 'all' && (
              <Button
                ...
                size="sm"
                onClick={() => setStatusFilter('all')}
                className="w-full gap-1 rounded-lg text-slate-500 hover:text-slate-900"
              >
                <X className="h-3.5 w-3.5" />
      ...
      <div className="flex items-center gap-6 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-500">
            <span className="font-medium text-slate-900">{pendingCount}</span> {t('swaps.pending')}
          </span>
        </div>
        <div className="flex items-center gap-2">
          <div className="h-2 w-2 rounded-full bg-emerald-500" />
          <span className="text-slate-500">
            <span className="font-medium text-slate-900">{approvedCount}</span> {t('swaps.approved')}
          </span>
        </div>
        <div className="flex items-center gap-2">
          <div className="h-2 w-2 rounded-full bg-slate-400" />
          <span className="text-slate-500">
            <span className="font-medium text-slate-900">{swaps.length}</span> {t('swaps.total')}
          </span>
        </div>
      </div>
...
function EmptyState({
  ...
  if (hasFilters) {
    return (
      <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-6 py-16 text-center">
        ...
        <h3 className="mb-1 text-lg font-semibold text-slate-900">{t('swaps.noMatching')}</h3>
        ...
        <Button
          ...
          className="gap-2 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50"
        >
          <X className="h-4 w-4" />
          {t('swaps.clearFilters')}
        </Button>
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-6 py-16 text-center">
      ...
      <p className="mb-6 max-w-sm text-sm text-slate-500">{config.description}</p>
      {tab === 'my-requests' && (
        <Button
